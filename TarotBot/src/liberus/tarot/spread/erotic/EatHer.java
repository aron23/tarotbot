...
public class EatHer extends Spread {
	...
	public EatHer(Interpretation myInt, String[] labels) {
		super(myInt);
		myNum = labels.length;
		myLabels = labels;
	}
	...
	public View populateSpread(View layout, AbstractTarotBotActivity act, Context ctx) {
		...
		card = (ImageView) layout.findViewById(R.id.eat_her_right);
		placeCustomImage(330,act.flipdex.get(2),card,ctx);
		card.setId(2);
		card.setOnClickListener(act);
