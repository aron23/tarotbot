...
public class EroticInt extends Interpretation {
	...
	public EroticInt(RiderWaiteDeck deck, Querant q) {
		super(deck);
		myQuerant = q;
		loaded=false;
	}
	
	public EroticInt(RiderWaiteDeck deck, Querant q, ArrayList<Integer> loading) {
		super(deck);
		myDeck = deck;
		myQuerant = q;
		working = loading;
