...
public abstract class Interpretation {
	...
	public static int getCardIndex(int card) {
			...
			if (card==R.id.trumps_01) return 0;
			if (card==R.id.trumps_02) return 1;
			if (card==R.id.trumps_03) return 2;
			if (card==R.id.trumps_04) return 3;
			if (card==R.id.trumps_05) return 4;
			if (card==R.id.trumps_06) return 5;
			if (card==R.id.trumps_07) return 6;
			if (card==R.id.trumps_08) return 7;
			if (card==R.id.trumps_09) return 8;
			if (card==R.id.trumps_10) return 9;
			if (card==R.id.trumps_11) return 10;
			if (card==R.id.trumps_12) return 11;
			if (card==R.id.trumps_13) return 12;
			if (card==R.id.trumps_14) return 13;
			if (card==R.id.trumps_15) return 14;
			if (card==R.id.trumps_16) return 15;
			if (card==R.id.trumps_17) return 16;
			if (card==R.id.trumps_18) return 17;
			if (card==R.id.trumps_19) return 18;		
			if (card==R.id.trumps_20) return 19;
			if (card==R.id.trumps_21) return 20;
			if (card==R.id.trumps_22) return 21;
	
			if (card==R.id.wands_01) return 22;
			if (card==R.id.wands_02) return 23;
			if (card==R.id.wands_03) return 24;
			if (card==R.id.wands_04) return 25;
			if (card==R.id.wands_05) return 26;
			if (card==R.id.wands_06) return 27;
			if (card==R.id.wands_07) return 28;
			if (card==R.id.wands_08) return 29;
			if (card==R.id.wands_09) return 30;
			if (card==R.id.wands_10) return 31;
			if (card==R.id.wands_page) return 32;
			if (card==R.id.wands_knight) return 33;
			if (card==R.id.wands_queen) return 34;
			if (card==R.id.wands_king) return 35;
	
			if (card==R.id.cups_01) return 36;
			if (card==R.id.cups_02) return 37;
			if (card==R.id.cups_03) return 38;
			if (card==R.id.cups_04) return 39;
			if (card==R.id.cups_05) return 40;
			if (card==R.id.cups_06) return 41;
			if (card==R.id.cups_07) return 42;
			if (card==R.id.cups_08) return 43;
			if (card==R.id.cups_09) return 44;
			if (card==R.id.cups_10) return 45;
			if (card==R.id.cups_page) return 46;
			if (card==R.id.cups_knight) return 47;
			if (card==R.id.cups_queen) return 48;
			if (card==R.id.cups_king) return 49;
	
			if (card==R.id.swords_01) return 50;
			if (card==R.id.swords_02) return 51;
			if (card==R.id.swords_03) return 52;
			if (card==R.id.swords_04) return 53;
			if (card==R.id.swords_05) return 54;
			if (card==R.id.swords_06) return 55;
			if (card==R.id.swords_07) return 56;
			if (card==R.id.swords_08) return 57;
			if (card==R.id.swords_09) return 58;
			if (card==R.id.swords_10) return 59;
			if (card==R.id.swords_page) return 60;
			if (card==R.id.swords_knight) return 61;
			if (card==R.id.swords_queen) return 62;
			if (card==R.id.swords_king) return 63;
	
			if (card==R.id.pent_01) return 64;
			if (card==R.id.pent_02) return 65;
			if (card==R.id.pent_03) return 66;
			if (card==R.id.pent_04) return 67;
			if (card==R.id.pent_05) return 68;
			if (card==R.id.pent_06) return 69;
			if (card==R.id.pent_07) return 70;
			if (card==R.id.pent_08) return 71;
			if (card==R.id.pent_09) return 72;
			if (card==R.id.pent_10) return 73;
			if (card==R.id.pent_page) return 74;
			if (card==R.id.pent_knight) return 75;
			if (card==R.id.pent_queen) return 76;
			if (card==R.id.pent_king) return 77;				
