...
public class Triangle extends Spread {
	...
	public Triangle(Interpretation myInt, String[] labels) {
		super(myInt);
		myNum = labels.length;
		myLabels = labels;
	}
	...
	public int getLayout() {
		return R.layout.trianglelayout;
	}

	public View populateSpread(View layout, AbstractTarotBotActivity act, Context ctx) {
		ImageView card = (ImageView) layout.findViewById(R.id.triangle_left);
